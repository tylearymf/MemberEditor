...
namespace Sirenix.Utilities.Editor
{
    ...
    public static class EditorIcons
    {
        ...
        //private static Texture angleKnob;
        ///// <summary>
        ///// Gets an icon of a unity error icon.
        ///// </summary>
        //public static Texture AngleKnob
        //{
        //    get
        //    {
        //        if (angleKnob == null)
        //        {
        //            angleKnob = LoadSpriteIcon(EditorGUIUtility.isProSkin ? "knobDark" : "knobLight");
        //        }
        ...
        //internal static Texture LoadSpriteIcon(string spriteName)
        //{
        //    string path = "Assets/" + SirenixAssetPaths.SirenixAssetsPath + "Editor/Icons.png";
        //    var sprite = AssetDatabase.LoadAllAssetsAtPath(path).OfType<Sprite>().First(x => x.name.ToLower() == spriteName.ToLower());
        //    return TextureUtilities.ConvertSpriteToTexture(sprite);
        //}
    }
}
#endif