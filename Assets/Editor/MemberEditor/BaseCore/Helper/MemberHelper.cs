namespace Tylearymf.MemberEditor
{
    ...
    static public class MemberHelper
    {
        ...
        static Dictionary<MemberTypes, Dictionary<string, IListDrawerInterface>> sIListDrawerDic;
        ...
        static public Dictionary<MemberTypes, Dictionary<string, IListDrawerInterface>> iListDrawerDic
        {
        ...
        static void InitDrawerInfoDic()
        {
            ...
            {
                sIListDrawerDic = new Dictionary<MemberTypes, Dictionary<string, IListDrawerInterface>>();
                var tAssembly = Assembly.GetAssembly(typeof(IListDrawerInterface));
                if (tAssembly == null) return;
                ...
                foreach (var item in tCustomList)
                {
                    ...
                    {
                        sIListDrawerDic.Add(tMemberType, new Dictionary<string, IListDrawerInterface>());
                    }
                    var tIListDrawer = Activator.CreateInstance(item) as IListDrawerInterface;
        ...
        static public Dictionary<string, IListDrawerInterface> GetIListDrawers(MemberTypes pMemberTypes)
        {
