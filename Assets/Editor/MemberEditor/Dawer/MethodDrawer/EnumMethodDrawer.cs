namespace Tylearymf.MemberEditor
{
    ...
    {
        Dictionary<int, Enum> mValues = new Dictionary<int, Enum>();
        ...
        public override object LayoutDrawer(Method pInfo, int pParamIndex = 0)
        {
            ...
            if (!mValues.ContainsKey(pParamIndex)) mValues.Add(pParamIndex, (Enum)Activator.CreateInstance(tParam.ParameterType));
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(tParam.Name, GUILayout.Width(tParam.Name.GetLabelWidth(this)));
            var tNewVal = EditorGUILayout.EnumPopup(mValues[pParamIndex]);
